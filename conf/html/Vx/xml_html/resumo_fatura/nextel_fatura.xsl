        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="2">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr valign="top">
                            <td class="text2" width="45%" height="45">
                                * O pagamento desta fatura não isenta o pagamento de eventuais saldos anteriores
                            </td>
                            <td width="55%" class="text3" align="right">
                                <b>VENCIMENTO:</b>

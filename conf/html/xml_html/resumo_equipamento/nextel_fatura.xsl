                ...
                <td colspan="2" height="331">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr width="100%">
                            <!-- Final do resumo por equipamento -->
                            <td width="600">
                                <!-- Créditos. Só mostra se houver algum -->
                                <xsl:if test="count(DETAILS/SUBSCRIBER/CREDITS/OCC) &gt; 0">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="text2bold" colspan="3">
                                                CRÉDITO
                        ...
                        <tr width="100%">
                            <!-- Final do resumo por equipamento -->
                            <td width="600">
                                <!-- Multas/Juros. Só mostra se houver algum -->
                                <xsl:if test="count(DETAILS/SUBSCRIBER/PENALTY_INTERESTS/OCC) &gt; 0">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td class="text2bold" colspan="3">

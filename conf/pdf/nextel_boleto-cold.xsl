...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
            ...
            <fo:layout-master-set>
                ...
                <fo:page-sequence-master master-name="boleto">
                    <!-- <fo:single-page-master-reference master-reference="A4-boleto"/> -->
                        <fo:repeatable-page-master-reference master-reference="A4-boleto"/>
                </fo:page-sequence-master>
            </fo:layout-master-set>

            <xsl:if test="/INVOICE/CUSTOMER/@SR = 'Y'">
                <fo:page-sequence initial-page-number="1" master-reference="boleto" keep-with-next.within-page="always">
    ...
    <xsl:template match="TELECOM|SERVICES" mode="FIRST">
        ...
        <fo:block text-align="left" font-size="6pt" font-family="Helvetica" font-weight="bold">
            ...
            <fo:table table-layout="fixed" height="15cm" border-top-style="solid"
                ...
                <fo:table-row>
                    <fo:table-cell display-align="center" border-bottom-style="solid" border-top-style="solid" 
                        ...
                        <fo:block text-align="left" font-size="6pt" font-family="Helvetica" 
                            ...
                            <!-- Mensagem da mudança de sede -->
                            <xsl:if test="(/INVOICE/CUSTOMER/@CID = '7') or (/INVOICE/CUSTOMER/@CID = '8') or (/INVOICE/CUSTOMER/@CID = '9') or (/INVOICE/CUSTOMER/@CID = '10') or (/INVOICE/CUSTOMER/@CID = '12') or (/INVOICE/CUSTOMER/@CID = '15') or (/INVOICE/CUSTOMER/@CID = '18')">
                                <fo:block start-indent="3mm" font-weight="normal">
                                    ATENÇÃO: NOVO ENDEREÇO SEDE A PARTIR DE 01/09/2004: AL. SANTOS, 2356/64
                                </fo:block>
                            </xsl:if>
                            <fo:block start-indent="3mm" font-weight="normal">

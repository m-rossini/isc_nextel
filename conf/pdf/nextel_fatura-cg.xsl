...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                exclude-result-prefixes="xalan phonenumber"
                version="1.0">

	<xsl:output method="xml" version="1.0" encoding="ISO-8859-1" omit-xml-declaration="no" indent="no"/>
    ...
    <xsl:template match="/">
      ...
      <fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
        ...
        <fo:layout-master-set>
            <fo:simple-page-master master-name="A4-resumo"
                page-height="29.7cm"
                page-width="21cm"
                margin-top="11.2mm"
                ...
                margin-left="11.2mm"
                margin-right="11.2mm">
                <fo:region-body margin-top="60mm"
                    margin-bottom="13mm"/>
                <fo:region-before extent="61mm"/>
                <fo:region-after extent="40mm"/>
            </fo:simple-page-master>
            <fo:simple-page-master master-name="A4-equip"
                page-height="29.7cm"
                page-width="21cm"
                margin-top="11.2mm"
                margin-bottom="11.2mm"
            ...
            <fo:simple-page-master master-name="A4-detalhe"
                page-height="29.7cm"
                page-width="21cm"
                margin-top="11.2mm"
                margin-bottom="11.2mm"
            ...
            <fo:page-sequence-master master-name="resumo-fatura-mensal">
                <fo:single-page-master-reference master-reference="A4-resumo"/>
            ...
            <fo:simple-page-master master-name="A4-extrato"
              page-height="29.7cm" page-width="21cm"
              margin-top="8mm" margin-bottom="7mm"
            ...
            <fo:simple-page-master master-name="A4-NF"
    ...
    <xsl:template match="CUSTOMER">
        ...
        <!-- * Primeira parte * -->
        <!-- ****************** -->
        <fo:page-sequence master-reference="resumo-fatura-mensal"
            ...
            <fo:static-content flow-name="xsl-region-before">
                <xsl:call-template name="HEADER">
                    ...
                    <xsl:with-param name="displayDueDate">true</xsl:with-param>
                </xsl:call-template>
            </fo:static-content>
        ...
        <!-- * Segunda parte * -->
        <!-- ***************** -->
        <fo:page-sequence master-reference="resumo-equipamento"
                          force-page-count="no-force">
            ...
            <fo:static-content flow-name="xsl-region-after" keep-with-next="always">
                <fo:block font-family="Helvetica" font-size="8pt">
                    ...
                    <fo:block>
                        <xsl:text>Contribuição para FUST - 1% do valor dos serviços - não repassadas as tarifas Art 9 Lei 9.998/2000</xsl:text>
                    </fo:block>
                    <fo:block>
                        <xsl:text>Contribuição para o FUNTEL - 0,5% do valor dos serviços - não repassadas as tarifas Art 6 &#xA7; 6° Lei 10.052/2000</xsl:text>
                    </fo:block>
                </fo:block>
            </fo:static-content>
    ...
    <xsl:template match="CONTRACT" mode="DETAILS">
        ...
        <xsl:if test="@T!='0,00'">
            ...
            <!-- * Terceira parte * -->
            <!-- ****************** -->
            <fo:page-sequence master-reference="detalhe-fatura"
                              force-page-count="no-force">

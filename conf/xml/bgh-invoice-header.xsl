...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="header">
        ...
        <!-- FATURA BRAILLE -->
        <xsl:variable name="billMedium"   select="RFF/REFERENCE[@CODE='LY']/@VALUE1"/>        
        ...
        <xsl:attribute name="M">
            ...
            <!-- xsl:value-of select="sql:getField('bscs', 'MagnusCode', 'ccjobdesc', $customerId)"/ -->
        </xsl:attribute>
        ...
        <!-- BILL MEDIUM - 6=FATURA BRAILLE -->
        <xsl:attribute name="BM">
           <xsl:value-of select="RFF/REFERENCE[@CODE='LY']/@VALUE1"/>
        </xsl:attribute>          
